...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/pandoraes/V2Ray-With-SSpanel/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
    echo ${DOWNLOAD_LINK}
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/pandoraes/V2Ray-With-SSpanel/releases/latest"
